...
@section('contant')
    ...
    @include('theme.partials_theme.hero', ['title' => 'Contact Us'])
                  ...
                  <div class="row">
                    <div class="col-lg-5">
                      <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <div class="form-group">
                                    <textarea class="form-control different-control w-100" value="{{ old('message') }}" name="message" id="message"
